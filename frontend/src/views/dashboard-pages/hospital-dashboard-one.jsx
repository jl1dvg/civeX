...
import OperationsTable from "../../components/tables/OperationsTable.jsx";
...
const HospitalDashboardOne = () => {
    ...
    const patients = [
        {
            ...
            name: "Petey Cruiser",
            doctors: [
                "/assets/images/user/05.jpg",
                "/assets/images/user/06.jpg",
                "/assets/images/user/07.jpg",
            ],
            date: "12-02-2020",
            report: "pdf",
            disease: "Fracture",
    ...
    const appointments = [
        {
            ...
            img: "/assets/images/page-img/30.png",
        },
        {
            count: 5000,
            text: "Completed Appointments",
            img: "/assets/images/page-img/31.png",
        },
        {
            count: 1500,
            text: "Cancelled Appointments",
            img: "/assets/images/page-img/32.png",
        },
        {
            count: 500,
            text: "Followup Appointments",
            img: "/assets/images/page-img/33.png",
        },
    ];
    ...
    const [topInsurances, setTopInsurances] = useState([]);
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((error) => {
                console.error("Error fetching top insurances:", error);
            });
    }, []);
                ...
                <Col lg={12}>
                    <Row>
                        {topInsurances.map((insurance, index) => {
                            // Lista de colores para las cards
                            const colors = [
                                "primary",
                                "success",
                                "danger",
                            ...
                            // Selecciona un color basado en el índice
                            const color = colors[index % colors.length];

                            return (
                                <Col md={6} lg={3} key={index}>
                                    <Card className={`bg-${color}-subtle`}>
                                        <Card.Body>
                                            <div className="d-flex align-items-center justify-content-between">
                                                <div className={`rounded-circle card-icon bg-${color}`}>
                                                    <i className="ri-user-fill text-white"></i>
                                                </div>
                                                <div className="text-end">
                                                    <h2 className={`mb-0 text-${color}`}>
                                                        <CountUp
                                                            start={0}
                                                            end={insurance.count}
                                                            duration={3}
                                                    ...
                                                    <h5 className={`text-${color} text-truncate`}>
                                                        {insurance.afiliacion || "No Info"}
                                                    </h5>
                                                </div>
                                            </div>
                                        </Card.Body>
                        ...
                        <div className="card-header d-flex justify-content-between position-relative pb-3">
                            ...
                            <div className="iqonic-navigation-custom d-flex align-items-end">
                                <div className="iqonic-navigation" id="navDemo">
                                    <div
                                        className="swiper-buttons swiper-button-prev static-position"
                                        tabIndex="0"
                                        role="button"
                                    ...
                                    <div
                                        className="swiper-buttons swiper-button-next static-position"
                                        tabIndex="-1"
                                        role="button"
                            ...
                            >
                                {staffMembers.map((member, index) => (
                                    <SwiperSlide key={index}>
                                        <div
                                            className="docter-list-item-inner rounded text-center"
                                            onClick={() => handleCardClick(member.id)} // `member.id` debe contener el ID del doctor
                                        ...
                                        >
                                            ...
                                            <div className="doctor-description">
                                                <p className="mb-0 text-center ps-2 pe-2">
                                                    {member.subespecialidad || "General"}
                                                </p>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                    ...
                    <Row>
                        ...
                        <Col md={12} lg={6}>
                            <Card className="iq-new-appoinments">
                                <Card.Header
                                    className="d-flex justify-content-between align-items-center recent-activity">
                                    <Card.Header.Title>
                                ...
                                <Card.Body>
                                    <ul className="timeline recent-activity">
                                        {activities.map((activity, index) => (
                                            <li key={index}>
                                                <div
                                                    className={`timeline-dots-fill ${activity.color}`}
                                                ></div>
